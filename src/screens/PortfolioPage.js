            ...
            <div className="portfolio__content">
                ...
                <div className="portfolio__cards">
                    <div className="card">
                        ...
                        <p> Built with Node, Express and Images on Cloudinary cloud on Backend. Client side build with React, Redux, React-Router, React-Bootstrap, Scss.</p>
                    ...
                    <div className="card">
                        <img alt="card" src="http://res.cloudinary.com/duvti2tkn/image/upload/v1622574305/evo7eve3kcqvypkp2scu.png"></img>
                        <h3>E-commerce</h3>
                        <p>This is a Real Ecommerce project, where I learned how to use <strong>React</strong>, <strong>Redux</strong>, <strong>Node</strong> and how to organize a full-stack project from start to finish.</p>
                        <div className="card__icons">
